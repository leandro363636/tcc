...
public class EventoFacade {
    ...
    public static List<Evento> buscarTodosEventosPorIdUsuarioPagAprovado(int pagina, int id) throws SQLException, ClassNotFoundException {
        EventoDAO eventodao = new EventoDAO();
        return eventodao.selectEventosIdPagAprovado(pagina, id);
    }
    ...
    public static int buscarTotalPorIdUsuarioAprovado(int id) throws SQLException, ClassNotFoundException {
        EventoDAO eventodao = new EventoDAO();
        return eventodao.selectCountEventosAprovados(id);
    }
