...
<html lang="pt-br">
    ...
    <body>
        ...
        <c:choose>
            <c:when test="${organizadores.size() gt 0}">
            <div class="row2">
                <div class="container">
                    <div class="row align-items-center my-5">
                        <div class="col-12 col-md-5">
                            <p class="center">ORGANIZADOR</p>
                        </div>
                    ...
                    <c:forEach items="${organizadores}" var="organizador">
                        <div class="row align-items-center">
                            <div class="col-12 col-md-5">
                                <p class="center"><c:out value="${organizador.nomeOrganizador}"/></p>
                            </div>

                            <c:if test="${organizador.ativo}">
                                <div class="col-12 col-md-2">
                                    <p class="center">ATIVO</p>
                                </div>
                                <div class="col-12 col-md-5">
                                    <p class="center">
                                        <a href="DeletarSuspenderOrganizadorServlet?action=desactive&id=<c:out value="${organizador.idOrganizador}"/>"><i class="fas fa-toggle-on" id="toggle1"></i></a>
                                        <a href="DeletarSuspenderOrganizadorServlet?action=delete&id=<c:out value="${organizador.idOrganizador}"/>"><i class="fas fa-trash-alt"></i></a>
                            ...
                            <c:if test="${!organizador.ativo}">
                                ...
                                <div class="col-12 col-md-5">
                                    <p class="center">
                                        <a href="DeletarSuspenderOrganizadorServlet?action=active&id=<c:out value="${organizador.idOrganizador}"/>"><i class="fas fa-toggle-off" id="toggle1"></i></a>
                                        <a href="DeletarSuspenderOrganizadorServlet?action=delete&id=<c:out value="${organizador.idOrganizador}"/>"><i class="fas fa-trash-alt"></i></a>
                                        <a href="#"><i class="fas fa-info-circle"></i></a>
                                    </p>
                                </div>
