...
<body>
    ...
    <div class="container">
        ...
        <form action="LoginServlet?action=login" method="POST" class="mb-0">
            <div class="form-group row">
                <div class="col-sm-5"></div>
                <input class="form-control col-sm-2 login" id="email" type="email" name="email" value="" placeholder="E-mail" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Login'" maxlength="50"><br/>
            </div>
            <div class="form-group row">
                <div class="col-sm-5"></div>
            ...
            <a href="RecuperarSenhaServlet?action=formNew">Esqueceu sua senha?</a><br><br>
        ...
        <div >Não possui uma conta ?</div> <a class="btn btn-outline-success" href="CadastrarServlet?action=formNew">cadatrar-se</a></div>
