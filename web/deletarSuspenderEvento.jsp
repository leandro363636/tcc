                            ...
                            <nav class="navbar navbar-expand-sm navbar-light bg-light">
                                ...
                                <div class="collapse navbar-collapse" id="navbarTopo">
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <c:if test="${sessionScope.usuario.tipo.equals(\"a\") || sessionScope.usuario.tipo.equals(\"o\")}">
                                            <li class="nav-item">
                                                <a class="nav-link" href="EventoServlet?action=list">Meus Eventos</a>
                                            </li>
                                        </c:if>
            ...
            <div class="row2">
                <div class="container">
                    ...
                    <c:forEach items="${eventos}" var="evento">
                        <div class="row align-items-center">
                            <div class="col-12 col-md-5">
                                <p class="center"><c:out value="${evento.nome}"/></p>
                            </div>
                            ...
                            <c:if test="${evento.aprovado}">
                                ...
                                <div class="col-12 col-md-5">
                                    <p class="center">
                                        <a href="DeletarSuspenderEventoServlet?action=desactive&id=<c:out value="${evento.id}"/>"><i class="fas fa-toggle-on" id="toggle1"></i></a>
                                        <a href="DeletarSuspenderEventoServlet?action=delete&id=<c:out value="${evento.id}"/>"><i class="fas fa-trash-alt"></i></a>
                            ...
                            <c:if test="${!evento.aprovado}">
                                ...
                                <div class="col-12 col-md-5">
                                    <p class="center">
                                        <a href="DeletarSuspenderEventoServlet?action=active&id=<c:out value="${evento.id}"/>"><i class="fas fa-toggle-off" id="toggle1"></i></a>
                                        <a href="DeletarSuspenderEventoServlet?action=delete&id=<c:out value="${evento.id}"/>"><i class="fas fa-trash-alt"></i></a>
                                        <a href="#"><i class="fas fa-info-circle"></i></a>
                                    </p>
                                </div>
